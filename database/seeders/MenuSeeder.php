    ...
    public function run(): void
    {
        ...
        $menus = [
            ...
            [
                ...
                'icon' => 'school',
                'permission' => ['view-kepegawaian-surat-balasan-pkl'],
                'parent_id' => 17,
                'group' => 'sdm',
            ],
            [
                ...
                'icon' => 'microscope',
                'permission' => ['view-kepegawaian-surat-balasan-penelitian'],
                'parent_id' => 17,
                'group' => 'sdm',
            ],
            [
                ...
                'icon' => 'clipboard-list',
                'permission' => ['view-kepegawaian-surat-perintah-tugas'],
                'parent_id' => 17,
                'group' => 'sdm',
            ],
            [
            ...
            [
                ...
                'icon' => 'file-text',
                'permission' => ['view-kepegawaian-surat-disposisi'],
                'parent_id' => 17,
                'group' => 'sdm',
            ],
            [
                ...
                'icon' => 'inbox',
                'permission' => ['view-kepegawaian-surat-disposisi-inbox'],
                'parent_id' => 17,
                'group' => 'sdm',
            ],
            [
