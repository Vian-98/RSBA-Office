<div>
    <form wire:submit.prevent='submit' class="flex flex-col gap-4" autocomplete="off">
        <div class="flex flex-col gap-2">
            <x-ts:input wire:model.defer='kategori' placeholder="Kategori Barang" />
        ...
        <div class="ml-auto flex justify-end gap-2">
            <x-ts:button outline color="black" x-on:click="$dispatch('close-modal',{id:'modal-new-kategori'})">Tutup</x-ts:button>
