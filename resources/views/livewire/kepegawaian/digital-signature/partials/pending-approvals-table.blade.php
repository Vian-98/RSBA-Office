<div class="space-y-4">
    ...
    {{-- MODALS PARTIALS --}}
    @include('livewire.kepegawaian.digital-signature.partials.modal-sign-approval')
    @include('livewire.kepegawaian.digital-signature.partials.modal-reject-approval')
    @include('livewire.kepegawaian.digital-signature.partials.modal-detail-approval')
</div>
