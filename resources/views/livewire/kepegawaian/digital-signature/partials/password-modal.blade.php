    ...
    <div class="fixed inset-0 z-50 overflow-y-auto bg-slate-900/65 backdrop-blur-sm flex items-center justify-center p-4">
        <div class="bg-white rounded-2xl max-w-lg w-full p-6 shadow-2xl border border-slate-100 space-y-5 animate-in fade-in zoom-in duration-150">
            ...
            <div class="flex items-center justify-end space-x-3 pt-2">
                <button wire:click="closePasswordModal" type="button" class="px-4 py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-700 text-sm font-semibold rounded-xl transition-colors cursor-pointer">
                    Batal
                </button>
                <button 
                    ...
                    class="px-5 py-2.5 bg-indigo-600 hover:bg-indigo-700 active:bg-indigo-800 text-white text-sm font-bold rounded-xl shadow-sm inline-flex items-center justify-center space-x-2 transition-all disabled:opacity-60 cursor-pointer"
                >
                    <span wire:loading.remove wire:target="confirmAndSign">Konfirmasi Sign & Kirim</span>
                    <span wire:loading.flex wire:target="confirmAndSign" class="inline-flex items-center justify-center gap-2 whitespace-nowrap">
