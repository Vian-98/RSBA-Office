<div class="flex flex-col gap-3">
    <div>
        <label class="block text-[10px] font-bold uppercase tracking-wider text-slate-400 mb-1">Scan QR Code Dokumen</label>
            ...
            <div class="rounded-xl border border-emerald-200 bg-emerald-50/30 p-5 space-y-4">
                <div class="flex items-center gap-2.5">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-emerald-700">Dokumen asli cocok dengan tanda tangan digital terdaftar</p>
                    </div>
                </div>
                ...
                <div class="border-t border-emerald-100 pt-3 space-y-2 text-xs text-slate-700">
                    <div class="grid grid-cols-3">
                        ...
                        <span class="col-span-2 font-bold text-slate-800">{{ $surat->no }}</span>
                    </div>
                    <div class="grid grid-cols-3">
